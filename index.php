...
<section class="slider-area" id="home">
   <div class="slider owl-carousel">
      ...
      ?>
         ...
         <div class="single-slide" style="background-image:url(' <?php the_post_thumbnail() ?> ')">
            <div class="container">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="slide-table">
                        <div class="slide-tablecell">
                           ...
                           if ($text_field) {
                           ?>
                              <a href="<?php echo  $link_field; ?>" class="box-btn"><?php echo  $text_field; ?> <i class="fa fa-angle-double-right"></i></a>
                           <?php
                           }
                           ?>
                        </div>
...
<section class="team-area pb-100 pt-100" id="team">
   <div class="container">
      ...
      <div class="row">
         ...
         while ($query->have_posts()) {
            $query->the_post();
            $team_facbook = get_post_meta(get_the_ID(), 'team_facbook', true);
            $team_google = get_post_meta(get_the_ID(), 'team_google', true);
                   ...
                   <div class="team-hover">
                     <div class="team-content">
                        ...
                        <ul>
                           ...
                           if ($team_facbook) {
                           ?>
                              <li><a href="<?php echo $team_facbook; ?>"><i class="fa fa-facebook"></i></a></li>
                           <?php
                           }
                           ?>
